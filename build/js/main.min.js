...
var _resetFocus = require("./utils/reset-focus");
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        for (var _i = 0, _arr = ['input', 'blur', 'focus']; _i < _arr.length; _i++) {
          var ev = _arr[_i];
          elem.addEventListener(ev, _phoneMask.onEventCalllback);
        }
      }
    } catch (err) {
      _iterator.e(err);
  ...
  window.addEventListener('load', function () {
    (0, _slider.checkHeroSlider)();
    (0, _slider.checkToursSlider)();
    (0, _slider.checkCoachesSlider)();
    (0, _slider.checkAdvantagesSlider)();
    (0, _slider.checkReviewsSlider)();
    (0, _slider.checkGallerySlider)();
    (0, _map.createMap)();
    (0, _video.findVideos)();
    (0, _menu.initMenu)();
    (0, _resetFocus.resetFocus)();
    (0, _form.formValidate)();
    (0, _audio.attachAudioPlayer)();
  });
});
...
},{"./modules/audio":3,"./modules/form":5,"./modules/map":6,"./modules/menu":7,"./modules/phone-mask.js":8,"./modules/slider":9,"./modules/video":10,"./utils/ios-vh-fix":12,"./utils/reset-focus":13}],3:[function(require,module,exports){
"use strict";
...
var playButton = document.querySelector('.player__play-button');
var audioPlayer = document.querySelector('.player');
var x = function x() {
  var btnYandex = document.querySelector('.button_2Savo');
  console.log(btnYandex);
};
...
var _pristinejs = _interopRequireDefault(require("pristinejs"));
var _regularExpression = require("./form-validate/regular-expression");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var formNode = document.querySelector('.questions__form');
var formValidate = function formValidate() {
  var pristine = new _pristinejs.default(formNode, {
  ...
  var inputName = formNode.querySelector('#name');
  pristine.addValidator(inputName, function (value) {
    if (!(0, _regularExpression.getLimitationsRegEx)('name').test(value)) {
      return true;
    }
    return false;
...
},{"./form-validate/regular-expression":4,"pristinejs":1}],6:[function(require,module,exports){
"use strict";
...
},{"../vendor/leaflet":14}],7:[function(require,module,exports){
"use strict";
...
exports.onEventCalllback = void 0;
...
exports.onEventCalllback = onEventCalllback;
...
exports.checkToursSlider = exports.checkReviewsSlider = exports.checkHeroSlider = exports.checkGallerySlider = exports.checkCoachesSlider = exports.checkAdvantagesSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var heroContainer = document.querySelector('.slider');
var toursContainer = document.querySelector('.tours__slider');
var coachesContainer = document.querySelector('.learning__slider');
var reviewsContainer = document.querySelector('.reviews__slider');
...
var checkHeroSlider = function checkHeroSlider() {
  var swiper = new _swiper.default(heroContainer, {
    simulateTouch: false,
    loop: true,
    speed: 300,
    pagination: {
...
exports.checkHeroSlider = checkHeroSlider;
var checkToursSlider = function checkToursSlider() {
  var swiper = new _swiper.default(toursContainer, {
    simulateTouch: false,
    speed: 300,
    navigation: {
...
exports.checkToursSlider = checkToursSlider;
var checkCoachesSlider = function checkCoachesSlider() {
  var swiper = new _swiper.default(coachesContainer, {
    simulateTouch: false,
    speed: 300,
    navigation: {
      nextEl: '.swiper__btn-next',
...
exports.checkCoachesSlider = checkCoachesSlider;
var checkReviewsSlider = function checkReviewsSlider() {
  var swiper = new _swiper.default(reviewsContainer, {
    simulateTouch: false,
    speed: 300,
    navigation: {
      nextEl: '.swiper__btn-next',
...
exports.checkReviewsSlider = checkReviewsSlider;
var checkAdvantagesSlider = function checkAdvantagesSlider() {
  var swiper = new _swiper.default(advantagesContainer, {
    simulateTouch: false,
    speed: 300,
    navigation: {
...
exports.checkAdvantagesSlider = checkAdvantagesSlider;
var checkGallerySlider = function checkGallerySlider() {
  var swiper = new _swiper.default(galleryContainer, {
    simulateTouch: false,
    speed: 300,
    navigation: {
...
exports.checkGallerySlider = checkGallerySlider;
